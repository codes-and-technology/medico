...
Delete-IfExists "k8s/api/auth-api/hpa.yml"
...
Delete-IfExists "k8s/api/appointments-api/hpa.yml"
...
Delete-IfExists "k8s/api/consulting-doctorstimetables-api/hpa.yml"
...
Delete-IfExists "k8s/api/create-doctors-timetables-api/hpa.yml"
...
Delete-IfExists "k8s/api/create-doctors-timetables-worker/hpa.yml"
...
Delete-IfExists "k8s/api/update-doctors-timetables-api/hpa.yml"
...
Delete-IfExists "k8s/api/update-doctors-timetables-worker/hpa.yml"
...
Delete-IfExists "k8s/api/delete-doctors-timetables-api/hpa.yml"
...
Delete-IfExists "k8s/api/delete-doctors-timetables-worker/hpa.yml"
Delete-IfExists "k8s/api/notification-worker/deployment.yml"
Delete-IfExists "k8s/api/notification-worker/service.yml"
Delete-IfExists "k8s/api/notification-worker/hpa.yml"
